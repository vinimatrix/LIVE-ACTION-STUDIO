...
ANTI-ALUCINACIÓN:
  - Mantener consistencia total del diseño y rostro de Sarada Uchiha (ref: Sarada Uchiha) exactamente como en la referencia de Flow
  - Mantener consistencia total del diseño y rostro de Shikamaru Nara (ref: Shikamaru Nara) exactamente como en la referencia de Flow
  - Mantener consistencia total del diseño y rostro de Konohamaru Sarutobi (ref: Konohamaru Sarutobi) exactamente como en la referencia de Flow
...
ESCENA 1 — Contexto Global (00:00 - 00:10)
──────────────────────────────────────────────────────────────────────
...
║  TRANSICIÓN OUT: Cut
║
║  PERSONAJES EN CUADRO:
║
║  ACCIÓN: Wide — construyendo atmósfera (neutral)
║  FOCO: Enfoque en wide: atmósfera neutral
║
║  ANTI-ALUCINACIÓN (shot específico):
║    - Mantener exactamente este encuadre: Wide, Slow Dolly
╚══ FIN SHOT 1 ══════════════════════════════════════════════════
...
║  PERSONAJES EN CUADRO:
║
║  ACCIÓN: Slow Push-In — construyendo atmósfera (neutral)
║  FOCO: Enfoque en slow_push-in: atmósfera neutral
║
║  ANTI-ALUCINACIÓN (shot específico):
║    - Mantener exactamente este encuadre: Slow Push-In, Slow Dolly
╚══ FIN SHOT 2 ══════════════════════════════════════════════════


================================================================================

ESCENA 2 — Contexto Global (00:10 - 00:20)
──────────────────────────────────────────────────────────────────────
...
ESCENA 3 — Contexto Global (00:20 - 00:30)
──────────────────────────────────────────────────────────────────────
...
ESCENA 4 — Contexto Global (00:30 - 00:40)
──────────────────────────────────────────────────────────────────────
...
ESCENA 5 — Contexto Global (00:40 - 00:50)
──────────────────────────────────────────────────────────────────────
